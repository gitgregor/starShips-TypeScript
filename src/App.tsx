...
interface State {
    crewP1: number;  // Number of people in crew
    crewP2: number;  // Number of people in crew

    nameP1: string;
    nameP2: string;

    all: Array<{ crew: number, name: string }> // array of alll data from API
    crew: Array<number>; // array of  crews's numbers  
    name: Array<string> // array of  SpaceCrafts's names

    c1: number;
    c2: number;

    hiddenPlayComponentFlag: boolean;
    WinFlag: string;
};
...
class App extends React.Component<Props, State> {
    constructor(props: Props) {
        ...
        this.state = {
            ...
            all: [], // array of alll data from API
    ...
    render() {
        ...
        return (
            ...
            <div className="App" style={{ backgroundImage: `url(${spaceship})`, backgroundSize: "cover", overflow: "hidden" }}>
                ...
                {/* ========== CARDS PAYLOADS ============ */}
                <div className="card1"><Card numberOfCrew={crewP1} spaceShipName={nameP1} player={"Player One"} playerName={"LUKE SKYWALKER"} /></div>
                <div className="card2"><Card numberOfCrew={crewP2} spaceShipName={nameP2} player={"Player Two"} playerName={"OBI-WAN"} /></div>
